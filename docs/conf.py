...
classname = "AFM + Flowmon Integrated Out-of-path DDoS Solution lab"

# OPTIONAL: The URL to the GitHub Repository for this class
github_repo = "https://github.com/sstarzh/Agility-2018-Afm-Flowmon-out-of-path-integrated-DDoS-solution"
